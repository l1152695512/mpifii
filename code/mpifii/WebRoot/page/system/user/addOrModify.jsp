...
<<<<<<< HEAD
				<c:if test="${empty userInfo.id}">
					<div class="control-group">
						...
						<div class="controls">
							<input type="hidden" id="orgId" name="orgId" value="${userInfo.org_id}"/>
							<input type="text" id="orgName" name="orgName" value="${userInfo.orgName}" 
								class="input-xlarge" readonly="readonly" maxlength="100" vMin="1" vType="length" onblur="onblurVali(this);">
							<button class="btn" type="button" onclick="orgRadioDiaLog('orgId', 'orgName','${orgId}');">选择</button>
							<span class="help-inline"></span>
						</div>
					</div>
					<div class="control-group">
