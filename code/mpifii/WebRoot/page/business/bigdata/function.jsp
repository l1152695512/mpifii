...
<form id="splitPage" class="form-horizontal" action="${pageContext.request.contextPath}/business/bigdata/user_behavior" method="POST">
	<div>
		<ul class="breadcrumb">
				...
				<table class="table table-striped table-bordered bootstrap-datatable ">
					<thead>
						<tr>
							...
							<th onclick="orderbyFun('counts')">点击次数</th>
							<th onclick="orderbyFun('dates')">访问时间</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="user" items="${splitPage.page.list}" >
							<tr>
								...
								<td class="center">${user.get("counts")}</td>
...
var myChart = new FusionCharts('file/charts/MSColumn3D.swf?ChartNoDataText=无数据显示', 'ad_chart_'+generRandomCharacters(10), "100%", 410);
myChart.setDataXML(dataXml);
myChart.render("chartDataXml");
...
function down(ctx){
	...
	var url=ctx+'/business/bigdata/downBehaviorFile?date='+date+'&orgId='+orgId+"&shopId="+shopId;
