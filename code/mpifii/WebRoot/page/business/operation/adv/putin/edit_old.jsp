...
<div id="ad_picture_edit">
	<form id="adv_form" action="business/oper/adv/putin/save" method="post" enctype="multipart/form-data">
			<input type="hidden" name="advId" value="${advId}">
			<input type="hidden" name="contentId" value="${contentId}">
			<div class="erlou">
				<div class="wenzi fl">名称：</div>
				<div class="kuang f1"><input type="text" name="name" value="${advName}"/></div>
				<div class="cl"></div>
			</div>
			<div class="yilou">
			...
			<div class="erlou">
				...
				<div class="kuang"><input type="text" name="link" value="${link}"/></div>
				<div style="clear:both;"></div>
			</div>
			<div class="sanlou">
...
<script type="text/javascript">
	...
	function submitInfo(){
		...
		if("${contentId}"=="" && localImgPath==""){
			myAlert("请上传图片！");
			return;
		}
		$("#ad_picture_edit form input[name=advId]").val("${advId}");
		$("#ad_picture_edit form input[name=contentId]").val("${contentId}");
		$("#adv_form").ajaxSubmit({
