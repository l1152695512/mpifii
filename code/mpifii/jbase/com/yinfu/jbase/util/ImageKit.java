...
public class ImageKit {
	...
	/**
	 * read image from file, now it can support image type: bmp,wbmp,gif,jpge,png
	 * 
	 * @param file
	...
	/**
	 * Output to file out according to the style<code>BufferedImage</code> If can not appoint image or formateName or
	 * file out ,do nothing. Now it can support image type：bmp,wbmp,jpeg,png.
	 * 
	 * @param image
	 *            BufferedImage.
	 * @param formatName
