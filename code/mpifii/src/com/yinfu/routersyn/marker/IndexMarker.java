...
//    	sql.append("where b.shop_id=?");
    	sql.append("select concat(?,'_',a.id) id,'' as link,");//ifnull(a.link,if(a.cloud_url is null,'#',concat('"+authServerPath+"','/',a.cloud_url,'/app-',a.id)))
    	...
    	System.err.println(PropertyUtils.getProperty("route.upload.type.app"));
    	System.err.println(shopId);
    	System.err.println(PageUtil.getPageIdByShopId(shopId));
    	System.err.println(PageUtil.getTemplateId(shopId));
