package com.yinfu.business.org.user.model;
...
public class User extends Model<User>
{
	...
	public void setRole(String userId, String roleIds) {
		if(userId != null && userId != null){
			...
			sqlList.add("delete from system_user_role where user_id="+userId);
			String[] src = roleIds.split(",");
			for(int i=0;i<src.length;i++){
				sqlList.add("insert into system_user_role(role_id,user_id) values("+src[i]+","+userId+")");
			}
